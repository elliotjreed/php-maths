...
final class Number extends NumberFormat
{
     ...
     * @return $this
     */
    public function add(self | NumberImmutable | int | float | string ...$number): self
    {
     ...
     * @return $this
     */
    public function subtract(self | NumberImmutable | int | float | string ...$number): self
    {
        $newNumber = $this->number;
        foreach ($number as $numberAsIntegerOrFloatOrString) {
            $numberAsString = $this->castNumberToString($numberAsIntegerOrFloatOrString);
     ...
     * @return $this
     */
    public function multiply(self | NumberImmutable | int | float | string ...$number): self
    {
        $newNumber = $this->number;
        foreach ($number as $numberAsIntegerOrFloatOrString) {
            $numberAsString = $this->castNumberToString($numberAsIntegerOrFloatOrString);
     ...
     * @return $this
     */
    public function modulus(self | NumberImmutable | int | float | string $divisorNumber): self
    {
    ...
    public function raiseToPowerReduceByModulus(
        ...
        self | NumberImmutable | int | float | string $divisorNumber
    ): self {
     ...
     * @return $this
     */
    public function increaseByPercentage(self | NumberImmutable | int | float | string $percent): self
    {
     ...
     * @return $this
     */
    public function decreaseByPercentage(self | NumberImmutable | int | float | string $percent): self
    {
        $percentAsString = $this->castNumberToString($percent);
